...
![Step 1 - Attack Result](../attacks/chain-2-web/screenshots/chain2-step1-attack-result.png)
...
![Step 1 - Suricata Log](../attacks/chain-2-web/screenshots/chain2-step1-suricata-log.png)

**Wazuh Dashboard:**
 
![Step 1 - SQL Injection Alert](../attacks/chain-2-web/screenshots/chain2-step1-sqli.png)
 
**Slack Notification:**
 
![Step 1 - Slack Alert](../attacks/chain-2-web/screenshots/chain2-step1-slack.png)
...
![Step 2 - Create Shell](../attacks/chain-2-web/screenshots/chain2-step2-create-shell.png)
...
![Step 2 - Upload DVWA](../attacks/chain-2-web/screenshots/chain2-step2-upload-dvwa.png)
...
![Step 2 - Suricata Log](../attacks/chain-2-web/screenshots/chain2-step2-suricata-log.png)

**Wazuh Dashboard:**
 
![Step 2 - Web Shell Upload Alert](../attacks/chain-2-web/screenshots/chain2-step2-webshell-upload.png)
 
**Slack Notification:**
 
![Step 2 - Slack Alert](../attacks/chain-2-web/screenshots/chain2-step2-slack.png)
...
![Step 3 - Result1](../attacks/chain-2-web/screenshots/chain2-step3-result1.png)

</br>

![Step 3 - Result2](../attacks/chain-2-web/screenshots/chain2-step3-result2.png)

</br>

![Step 3 - Result3](../attacks/chain-2-web/screenshots/chain2-step3-result3.png)

</br>

![Step 3 - Result4](../attacks/chain-2-web/screenshots/chain2-step3-result4.png)
...
![Step 3 - Suricata Log](../attacks/chain-2-web/screenshots/chain2-step3-suricata-log.png)

**Wazuh Dashboard:**
 
![Step 3 - RCE Alert](../attacks/chain-2-web/screenshots/chain2-step3-rce.png)
 
**Slack Notification:**
 
![Step 3 - Slack Alert](../attacks/chain-2-web/screenshots/chain2-step3-slack.png)
...
![Step 4 - Attack](../attacks/chain-2-web/screenshots/chain2-step4-attack.png)
...
![Step 4 - Suricata Log](../attacks/chain-2-web/screenshots/chain2-step4-suricata-log.png)

Note: Source IP is `10.10.1.133` (Victim) — the compromised machine is exfiltrating, not the attacker directly.

**Wazuh Dashboard:**
 
![Step 4 - DNS Exfil Alert](../attacks/chain-2-web/screenshots/chain2-step4-dns-exfil.png)
 
**Slack Notification:**
 
![Step 4 - Slack Alert](../attacks/chain-2-web/screenshots/chain2-step4-slack.png)
...
```
#fields  ts          uid         id.orig_h    query                    qtype_name
23:55:03 CxYz123     10.10.1.133  secret1.attacker.com   A
23:55:03 CxYz124     10.10.1.133  secret2.attacker.com   A
23:55:03 CxYz125     10.10.1.133  secret3.attacker.com   A
...
```
...
![Zeek DNS Log](../attacks/chain-2-web/screenshots/chain2-zeek-dns-log.png)
